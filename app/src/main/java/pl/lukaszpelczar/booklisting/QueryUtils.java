...
/**
 * Helper methods related to requesting and receiving earthquake data from Book API.
 */
public final class QueryUtils {
    ...
    /**
     * Query the Book API and return a list of {@link Book} objects.
     */
    ...
    private static List<Book> extractFeatureFromJson(String bookJSON) {
        ...
        try {
            ...
            for (int i = 0; i < booksArray.length(); i++) {
                ...
                //Extract the JSONArray of authors
                ...
                Book book = new Book(url, title, date, author);
